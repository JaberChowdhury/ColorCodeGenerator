...
L.cloneElement = function (e, n, t) {
  ...
  if (n != null) {
    if (
      (n.ref !== void 0 && ((u = n.ref), (o = Hu.current)),
...
function nu(e, n) {
  ...
  n.hasOwnProperty("value")
    ? tu(e, n.type, t)
    : n.hasOwnProperty("defaultValue") && tu(e, n.type, cn(n.defaultValue)),
    n.checked == null &&
...
function Yo(e) {
  if ((e = Zt(e))) {
    ...
    var n = e.stateNode;
    n && ((n = ll(n)), su(e.stateNode, e.type, n));
  }
}
function ms(e) {
...
function $c(e, n, t, r, l, u, o, i, s) {
  (kt = !1), (Tr = null), jc.apply(Uc, arguments);
}
function Ac(e, n, t, r, l, u, o, i, s) {
  if (($c.apply(this, arguments), kt)) {
    if (kt) {
      var c = Tr;
      (kt = !1), (Tr = null);
...
function Ss(e) {
  return (e = Vc(e)), e !== null ? ks(e) : null;
}
function ks(e) {
...
function ft(e, n) {
  e.blockedOn === n &&
    ...
    du ||
      ((du = !0),
      he.unstable_scheduleCallback(he.unstable_NormalPriority, nf)));
}
function It(e) {
  function n(l) {
    return ft(l, e);
...
function no(e, n, t, r) {
  if (Dr) {
    var l = pu(e, n, t, r);
    if (l === null) Ml(e, n, r, Ir, t), Zo(e, r);
    else if (ef(l, e, n, t, r)) r.stopPropagation();
    else if ((Zo(e, r), n & 4 && -1 < bc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Zt(l);
        if (
          (u !== null && Ns(u),
...
var Ir = null;
function pu(e, n, t, r) {
  if (((Ir = null), (e = Ju(r)), (e = wn(e)), e !== null))
...
var lt = {
  ...
  Pl = ge(sf),
  af = A({}, lt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  cf = ge(af),
  ff = A({}, lt, {
...
var gf = A({}, Gt, {
  ...
  Ef = ge(kf),
  Cf = A({}, lt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  _f = ge(Cf),
  xf = A({}, nl, {
    deltaX: function (e) {
  ...
  Pf = ge(xf),
  Nf = [9, 13, 27, 32],
  uo = He && "CompositionEvent" in window,
  Et = null;
He && "documentMode" in document && (Et = document.documentMode);
var zf = He && "TextEvent" in window && !Et,
  Ds = He && (!uo || (Et && 8 < Et && 11 >= Et)),
...
function Tf(e, n) {
  if (Dn)
    return e === "compositionend" || (!uo && Is(e, n))
      ? ((e = Ms()), (Sr = to = be = null), (Dn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function $s(e) {
  if (e.propertyName === "value" && tl(Ft)) {
    var n = [];
    js(n, Ft, e, Ju(e)), gs(Of, n);
  }
}
function Df(e, n, t) {
  e === "focusin"
    ? (oi(), (Ct = n), (Ft = t), Ct.attachEvent("onpropertychange", $s))
    : e === "focusout" && oi();
}
function If(e) {
...
var wt =
  ...
  Hf = new Set("cancel close invalid load scroll toggle".split(" ").concat(wt));
function fi(e, n, t) {
...
var wu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Yf =
    typeof queueMicrotask == "function"
      ...
      : typeof mi < "u"
      ? function (e) {
          return mi.resolve(null).then(e).catch(Xf);
        }
      : wu;
function Xf(e) {
  setTimeout(function () {
...
function mn() {
  if (!Il && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Es(qu, mn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function Pu(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ra), vo(e);
  var u = n.contextType;
  typeof u == "object" && u !== null
    ? (l.context = Ce(u))
...
function So(e, n, t, r, l, u) {
  if (
    ...
    u = 0;
    do {
      if (((xt = !1), (Ht = 0), 25 <= u)) throw Error(y(301));
      (u += 1),
        (G = K = null),
        (n.updateQueue = null),
        (Cr.current = ud),
  ...
  rd = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Qt(9, fa.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
  ...
  return (
    ...
    e !== null && !ae
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ke(e, n, l))
      : (j && t && io(n), (n.flags |= 1), le(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ae
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ke(e, n, l))
      : (j && r && io(n), (n.flags |= 1), le(e, n, t, l), n.child)
  );
}
function Oi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    xr(e, n), la(n, t, r), Pu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function Mi(e, n, t, r, l) {
  return qn(), ao(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
...
function sd(e, n, t, r, l, u, o) {
  ...
  if (((i = (o & e.childLanes) !== 0), ae || i)) {
    ...
    return To(), (r = Al(Error(y(421)))), pr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function cd(e, n, t) {
  ...
  switch ((so(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (fr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Le !== null && (Au(Le), (Le = null)))),
        Ou(e, n),
        ne(n),
        null
      );
    ...
    case 13:
      if (
        ...
        if (j && me !== null && n.mode & 1 && !(n.flags & 128))
          ...
          ne(n), (u = !1);
        } else Le !== null && (Au(Le), (Le = null)), (u = !0);
    ...
    case 4:
      return (
        et(), Ou(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
      return po(n.type._context), ne(n), null;
    case 17:
      return fe(n.type) && Ur(), ne(n), null;
    case 19:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[Su], delete n[Gf], delete n[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Fu(e, n, t) {
  ...
  if (r === 5 || r === 6)
    ...
    for (Fu(e, n, t), e = e.sibling; e !== null; ) Fu(e, n, t), (e = e.sibling);
}
var J = null,
  ze = !1;
function Xe(e, n, t) {
...
function Ba(e, n, t) {
  for (var r = (e.mode & 1) !== 0; k !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && u !== null ? ((u.return = l), (k = u)) : Ui(e);
  }
}
function Ui(e) {
  for (; k !== null; ) {
...
function Re(e, n, t, r) {
  if (50 < zt) throw ((zt = 0), (Uu = null), Error(y(185)));
  Xt(e, t, r),
    (!(R & 2) || e !== Z) &&
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Go(t), n === 1))
      e.tag === 0 ? Jf(Vi.bind(null, e)) : Js(Vi.bind(null, e)),
        Yf(function () {
          !(R & 6) && mn();
        }),
        (t = null);
...
function Ha(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = fu(e)), l !== 0 && ((r = l), (n = $u(e, l)))), n === 1)
    )
    ...
    if (n === 6) qe(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = No + 500 - W()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = wu(gn.bind(null, e, se, Ue), n);
            break;
          }
          gn(e, se, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = wu(gn.bind(null, e, se, Ue), r);
            break;
          }
          gn(e, se, Ue);
          break;
...
function Jr(e, n) {
  ...
  while (1);
  if ((fo(), (R = t), (Xr.current = r), Q !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function yd() {
  for (; Q !== null; ) Ka(Q);
...
function wd(e, n, t, r) {
  ...
  if (Gr) throw ((Gr = !1), (e = ju), (ju = null), e);
  return (
    Zr & 1 && e.tag !== 0 && Gn(),
    (u = e.pendingLanes),
    u & 1 ? (e === Uu ? zt++ : ((zt = 0), (Uu = e))) : (zt = 0),
    mn(),
    null
  );
}
...
function Sd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    Z === e &&
      (q & t) === t &&
      (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - No)
        ? En(e, 0)
        : (Po |= t)),
    de(e, n);
}
...
Ga = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return (ae = !1), ad(e, n, t);
      ae = !!(e.flags & 131072);
    }
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Pu(n, r, e, t),
            (n = Lu(null, n, r, !0, u, t)))
          : ((n.tag = 0), j && u && io(n), le(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
...
function zr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) Ro(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Zl:
        return (
          (e = ke(12, t, n, l | 2)), (e.elementType = Zl), (e.lanes = u), e
        );
      case Jl:
        return (e = ke(13, t, n, l)), (e.elementType = Jl), (e.lanes = u), e;
      case ql:
        return (e = ke(19, t, n, l)), (e.elementType = ql), (e.lanes = u), e;
      case us:
        return cl(t, l, u, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (bu(n, t | 1), de(n, W()), !(R & 6) && ((tt = W() + 500), mn()));
      }
      break;
    case 13:
      zn(function () {
...
hs = zo;
ys = zn;
var Ld = { usingClientEntryPoint: !1, Events: [Zt, jn, ll, ms, vs, zo] },
  vt = {
...
function Rd() {
  return Ql("div", { children: "App components is here" });
}
Kl.createRoot(document.getElementById("root")).render(
  Ql(wc.StrictMode, { children: Ql(Rd, {}) })
);
